...
public class CameraFrame : MonoBehaviour
{
    ...
    [SerializeField]
    private CameraColorPicker cameraColorPicker;
    ...
    private unsafe void UpdateCameraTexture(XRCpuImage image, bool convertYuvManually)
    {
        ...
        rt.sizeDelta = new Vector2(_cameraTexture.width, _cameraTexture.height);
        CameraRawImage.texture = _cameraTexture;
        cameraColorPicker.cameraTexture = _cameraTexture;
    }
